// Generate button selector + clicking
document.querySelector('.generate-btn').addEventListener('click', pinFun);

// calculator buttons selector + clicking
document.querySelector('.calc-body').addEventListener('click', setPin)

// Clear button selector + clicking
document.querySelector('#clear-btn').addEventListener('click', function () {
    displayGuessed.value = ''
    blockInput()
})

//delete button selector + clicking
document.querySelector('#delete-btn').addEventListener('click', function () {
    displayGuessed.value = displayGuessed.value.slice(0, -1)
    blockInput()
})

// submit button selector + clicking
document.querySelector('.submit-btn').addEventListener('click', submitFunction)

// display generate pin
document.querySelector('#displayGenerated').addEventListener('input', blockInput)

// display guessed pin
document.querySelector('#displayGuessed').addEventListener('input', blockInput)

// function area

// generate and show the pin
var leftTries = 3
function pinFun() {
